...
const ToDoList = ({ entry, items,  handleListButtonClick, handleListItemButtonClick, handleChange, handleCheckChange, checkedItems }: ToDoListProps) => {
    ...
    <List items={items} handleListItemButtonClick={handleListItemButtonClick} handleCheckChange={handleCheckChange} checked={checkedItems} />
    </section>
    )
};
