    ...
    return (
        ...
        forecastInfo.map(forecast => {
         <section className={classname}>
            <WeeklyForecast classname={classname} day={forecast.date[0]} minTemp={forecast.day.mintemp_c} maxTemp={forecast.day.maxtemp_c} condition={forecast.day.condition.text} conditionImage={forecast.day.condition.icon} />
